// Hero.jsx — full-bleed hero with massive wordmark + 3s-rotating slogan + ambient bg
...
function HeroBg({ variant }) {
  ...
  if (variant === "dots") {
    return (
      <>
        <div className="hero-anim-blob" style={{ opacity: 0.35 }}>
          <div className="blob a" />
          <div className="blob b" />
        </div>
        <div className="hero-anim-dots" />
      </>);
...
function Hero({ bgVariant = "blobs" }) {
  ...
  return (
    <section id="inicio" data-screen-label="01 Hero" className="hero">
      {/* video background — loops endlessly */}
      <video
        ref={videoRef}
        ...
        playsInline
        preload="auto"
        src="uploads/fondo_1920_1080_30fps.mp4" />
      ...
      <div className="hero-body container">
        ...
        {/* Massive logo */}
        <img
          src={typeof window !== "undefined" && window.__resources && window.__resources.logoDark || "assets/clasico-logo-dark.png"}
          alt="clasi.co"
          className="hero-logo" />
        ...
        <div className="hero-meta">
          <TextRollButton label="Conversemos" href="#footer" onClick={(e) => {e.preventDefault();smoothTo("footer");}} />
