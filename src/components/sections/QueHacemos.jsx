const FALLBACK_IMG = 'https://images.unsplash.com/photo-1543269664-76bc3997d9ea?auto=format&fit=crop&w=1400&q=80'
      ...
      <div className="container">
        ...
        <div className="split-2" style={{ alignItems: 'stretch' }}>
          ...
          <div className="qh-image">
            <img src={FALLBACK_IMG} alt="Personas comentando una marca clásica" loading="lazy" />
