// Como.jsx — "Buenas ideas. Bien pensadas. Bien hechas." + horizontal process infographic.
const { useState: useStateC } = React;
const { ArrowRight: ArrowRightC } = window.ClasicoIcons;
  ...
  return (
    <section id="como" data-screen-label="03 Como" className="section-pad bg-paper-0">
      <div className="container">
        ...
        {/* Horizontal process infographic */}
        <div className="process">
          ...
          <div className="process-flow">
            {/* line + animated progress (desktop only) */}
                ...
                <button
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 16, position: "relative" }}>
                    ...
                    <span className="process-arrow" aria-hidden="true">
                      <ArrowRightC size={12} strokeWidth={2.2} />
                    </span>
                  </div>
                  ...
                  <div className="process-card">
                    <div className="process-card-head">
                      ...
                      <span className="process-card-stage">
                        Fase {i + 1} / {STEPS.length}
                      </span>
                    </div>
