// Footer.jsx — big closing line, contact email center, socials right.
const { Linkedin, Instagram, Mail } = window.ClasicoIcons;
      ...
      <div className="container">
        ...
        <div className="foot-grid">
          <div>
            ...
            <p style={{ marginTop: 16, fontSize: 13, color: "rgba(255,255,255,0.6)", maxWidth: 320 }}>
          ...
          <div className="foot-right">
            <a className="foot-social" href="#" aria-label="LinkedIn"><Linkedin size={18} /></a>
            <a className="foot-social" href="#" aria-label="Instagram"><Instagram size={18} /></a>
